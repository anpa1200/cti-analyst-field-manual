...
![CTI workflow — 12-step model from customer decisions through PIR/SIR, sources, evidence register, threat scenarios, telemetry, hunts, detections, tests, metrics, and refresh](/img/cti-workflow-12-steps.png)
